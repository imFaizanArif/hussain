    ...
    return (
        <div className={`w-full ${bgColor}`}>
            <div className='py-[15px] sm:py-[15px] lg:py-[60px] text-primary max-w-[1360px] mx-auto'>
                ...
                {img2 && <div className={`flex flex-col md:flex-row ${flow} py-[30px] px-[30px] sm:px-[30px] md:[px-45] lg:px-[60px] mx-auto`}>
                    <img src={img2} alt="" className={`${imgSize} mr-0 md:mr-24 mt-12 sm:mt-12 md:mt-0`} />
                </div>}
            </div>
        </div>
    )
