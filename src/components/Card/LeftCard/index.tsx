...
export const LeftCard: React.FC<LeftCardProps> = ({ flow, color }) => {
    return (
        <div className={`w-full md:w-1/2 ${color ? color : 'text-primary'} ${flow ? flow : 'flex-col justify-start items-start'}`}>
